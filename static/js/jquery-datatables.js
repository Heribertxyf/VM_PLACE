		...
		function _fnFilter( oSettings, sInput, iForce, bRegex, bSmart, bCaseInsensitive )
		{
			...
			else
			{
					   ...
					   sInput.indexOf(oPrevSearch.sSearch) !== 0 )
				{
					...
					{
                        var sData = _fnDataToSearch(oSettings.asDataSearch[i], "html");
						if ( rpSearch.test(sData) )
						{
...
$.extend( true, $.fn.dataTable.defaults, {
    ...
    "oLanguage": {
        ...
        "sEmptyTable": "",
        "oPaginate": {
            "sPrevious": I18N.t('sPrevious'),
            "sNext": I18N.t('sNext'),
            "sFirst": I18N.t('sFirst'),
            "sLast": I18N.t('sLast')
        }
    }
} );
...
/*
 * Data Table HTML Tag type filter and sorter
 */

function hasHTMLTag(data) {
    var reg = /<.+?>(.*?)<\/.+?>/i;
...
jQuery.fn.dataTableExt.oSort['custom-html-asc']  = function(a,b) {
	var x = getHTMLContent(a);
	var y = getHTMLContent(b);
	return ((x < y) ? -1 : ((x > y) ?  1 : 0));
};
