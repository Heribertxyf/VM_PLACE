    var interval_key;
     ...
     function link_here(){
        ...
        $.ajax({
            type:"POST",
            url: "/monitor/get_isp_link_detail_data",
            traditional:true,
            data:add_csrf_token({
        ...
        //interval_key=setInterval(function() {draw('abc',start_node,end_node,start_time,end_time,radio);},10000);
        //interval_key=setInterval(function(){hi('abc')},5000);
        var radio = 60;
        interval_key = setInterval(function(){hi('abc',start_node,start_time,end_time,radio);},60000);
    } 
    if ($('#isp_ip').val() != ''){
        link_here();
    }
    ...
    $('#filter1').click(function(){
        ...
        if(start_time=='' && end_time==''){
            radio = 60;
            draw('abc',start_node,start_time,end_time,radio); 
            clearInterval(interval_key);
    ...
    function hi(url,start_node,start_time,end_time,period){
        var myDate = new Date();
        $('#draw_title').text(myDate.toLocaleString());
    ...
    function draw(url, start_node, start_time, end_time, period) {
